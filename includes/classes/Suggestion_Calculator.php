...
class Suggestion_Calculator {
	...
	public function __construct( $post_id ) {
		...
		$this->number_of_suggestion_calculation = get_option('number_of_suggestion_calculation', 20);
	}
...
//	    $post_suggestion_ids = $this->remove_duplicates($post_suggestion_ids);
	...
	public function update_post( $post_suggestion_ids ) {
		...
		sell_log( 'End of calculation: ' . implode( ', ', $post_suggestion_ids ) );
		update_post_meta( $this->post_id, 'sellmagazin_suggestion_last_update', $now->format( 'm/d H:i:s' ) );
		update_post_meta( $this->post_id, 'sellmagazin_suggestions', $post_suggestion_ids );
	}
